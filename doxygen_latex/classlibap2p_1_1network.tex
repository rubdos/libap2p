...
\{
        ...
        this->\_server = \textcolor{keyword}{new} server(\textcolor{keyword}{this}, 12011);
        \textcolor{keywordflow}{if}(this->\_nodes.size() == 0)
        \{
                \textcolor{comment}{// No nodes added, just start the server. Networks can be
       joined togheter later on.}
                this->\_connection\_status = CONNECTED;
        \}
        this->\_server->run();
\}
\end{DoxyCode}
