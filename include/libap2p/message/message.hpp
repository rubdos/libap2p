...
public:
    ...
    void Prepare();
    /** Prepares the message and generates a corresponding signature.
     */
    void Prepare(Identity* id_from);
    /** Prepares the message, encrypts and signs it.
     */
    void Prepare(Identity* id_from, Identity* id_to);
